...
public class Student {
    ...
    public void setStudent_id(String studentId) { this.student_id = student_id; }

    public List<String> getEnrolled_courses() { return enrolled_courses; }
    public void enrollCourse(String courseCode) { enrolled_courses.add(courseCode); }
    @Override
